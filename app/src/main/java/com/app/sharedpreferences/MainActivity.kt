...
class MainActivity : AppCompatActivity() {
    ...
    private fun iniciarComponentes() {
        ...
        var btnIrASecondActivity:Button=findViewById(R.id.btnIrASecondActivity)
        btnIrASecondActivity.setOnClickListener { irASecondActivity() }

    }
    private fun irASecondActivity() {
